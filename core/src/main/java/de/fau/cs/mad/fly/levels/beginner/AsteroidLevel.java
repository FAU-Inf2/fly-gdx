...
import de.fau.cs.mad.fly.levels.AsteroidBelt;
 ...
 * 
 */
public class AsteroidLevel extends AsteroidBelt implements ILevel, IFeatureInit {
    ...
    public void init(GameController game) {
        InfoOverlay.getInstance().setOverlay(I18n.tLevel("beginner.asteroid"), 4);
    }
}