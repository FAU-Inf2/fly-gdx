...
/**
 * Level script file for the level where a hidden path may leed faster to the goal.
 * 
 * @author Lukas Hahmann <lukas.hahmann@gmail.com>
 * 
 */
public class HiddenPathLevel implements ILevel, IFeatureInit {
    ...
    public void init(GameController game) {
        InfoOverlay.getInstance().setOverlay(I18n.tLevel("beginner.hidden.path"), 5);
    }
