...
public class SQLiteResultCodes {
    ...
    public final static int SQLITE_IOERR = 10; /*
                                                * Some kind of disk I/O error
                                                * occurred
                                                */
    public final static int SQLITE_CORRUPT = 11; /*
                                                  * The database disk image is
                                                  * malformed
                                                  */
    ...
    public final static int SQLITE_ROW = 100; /*
                                               * sqlite3_step() has another row
                                               * ready
                                               */
    public final static int SQLITE_DONE = 101; /*
                                                * sqlite3_step() has finished
                                                * executing
                                                */
