 ...
 * <p>
 * Extends ModelInstance with features for frustum culling and collision detection.
 * 
 * @author Tobias Zangl
 */
public class GameObject extends ModelInstance implements Disposable {
	...
	/**
	 * Creates a new GameObject with btBoxShape with the size of the BoundingBox.
	 */
	public GameObject(Model model, String rootNode, boolean mergeTransform) {
		...
		body.setCollisionShape(new btBoxShape(bounds.getDimensions().cpy().scl(0.5f)));
	}
	
	/**
	 * Creates a new GameObject with given btCollisionShape.
	 */
	public GameObject(Model model, String rootNode, btCollisionShape shape, boolean mergeTransform) {
		super(model, rootNode, mergeTransform);
