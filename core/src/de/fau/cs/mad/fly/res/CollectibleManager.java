...
public class CollectibleManager {
     ...
     * @param collectibles		The list of collectibles.
     */
     ...
     * @param c		The collectible that should be added.
     */
     ...
     * @param c		The collectible that should be removed.
     */
