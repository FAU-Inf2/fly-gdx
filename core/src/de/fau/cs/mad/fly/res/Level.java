...
public class Level extends Resource {
	...
	public ModelInstance getLevelBorder() {
		return new ModelInstance(Assets.manager.get(new AssetDescriptor<Model>(levelBorder, Model.class)));
	}
	...
	public void render(PerspectiveCamera camera) {
		...
		for (Gate g : gates) {
			...
			ModelInstance mi = new ModelInstance(Assets.manager.get(m.descriptor));
	...
	public String toString() {
		return "#<Level:" + id + " name=" + name + " startingPoint=" + start + " gates=" + gates;
	}
}
 ...
 */
	/* public boolean check() {
		...
		if (id != null && !name.isEmpty() && firstSection != null && sections != null && firstSection.isComplete()) {
			int i = 0;
