...
public class AndroidDatabaseManager implements DatabaseManager {
	...
	private class AndroidDatabase implements Database {
		...
		private com.badlogic.gdx.sqlite.android.SQLiteDatabaseHelper helper;
		...
		public void setupDatabase() {
			helper = new com.badlogic.gdx.sqlite.android.SQLiteDatabaseHelper(this.context, dbName, null, dbVersion,
